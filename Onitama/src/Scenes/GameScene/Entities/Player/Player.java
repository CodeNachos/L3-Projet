...
public class Player extends GameObject {
    ...
    private void initCards(String card1Name, String card2Name, String standByName) {
        ...
        idleCardSprite.setBorder(5, playerId == GameScene.RED_PLAYER ? Main.Palette.red : Main.Palette.cyan, 10);
        ...
        selectedCardSprite.setBorder(5, playerId == GameScene.RED_PLAYER ? Main.Palette.red.brighter() : Main.Palette.cyan.brighter(), 10);
