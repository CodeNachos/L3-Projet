...
public class ControlFrame extends MenuFrame {
    ...
    public ControlFrame() {
        ...
        JLabel title = new JLabel(" GAME CONTROLS ", SwingConstants.CENTER);
        ...
        String fileContent = HowToPlayScene.readFile("Onitama/res/Rules/Control.txt");
